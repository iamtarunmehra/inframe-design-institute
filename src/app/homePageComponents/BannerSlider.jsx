...
export default function BannerSlider() {
    ...
    return (
        <div className='w-[100%] pb-10 overflow-hidden'>
            <Slider {...settings}>
                <div>
                    <img className='w-[100%] lg:h-[80vh] ' src="https://www.inframedesigninstitute.com/images/homesliderpic/1732701125MOCK_TEST01.jpg" alt="" />
                </div>
                <div>
                    <img className='w-[100%] lg:h-[80vh] ' src="https://www.inframedesigninstitute.com/images/homesliderpic/168845617729-June-Book.jpg" alt="" />
                </div>
                <div>
                    <img className='w-[100%] lg:h-[80vh] ' src="https://www.inframedesigninstitute.com/images/homesliderpic/1732702600GET_COURSE.jpg" alt="" />
                </div>
            </Slider>
